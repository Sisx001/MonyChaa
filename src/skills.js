...
const CATALOG = [
  ...
  { name: 'Meeting Notes', description: 'Recaps action items after a discussion.', triggers: ['action items', 'to summarize', 'recap', 'next steps', 'takeaways'], content: 'When a conversation settles decisions, offer a short recap: who owns what, any dates, and the single next step. Keep it to a few bullet-like lines, confirm nothing you\'re unsure of.' },
  { name: 'Networking Follow-up', description: 'Reconnects professionally after meeting someone.', triggers: ['nice to meet', 'great chatting', 'connect', 'let\'s keep in touch', 'follow up'], content: 'For professional follow-ups: reference something specific from the prior contact, keep it warm but brief, and propose one concrete way to stay in touch or a small next step.' },
  { name: 'Contact Info Collector', description: 'Politely gathers email/phone when needed.', triggers: ['reach you', 'contact details', 'email address', 'phone number', 'how do i get in touch'], content: 'When you genuinely need contact details to help, ask for just what\'s necessary, explain briefly why, and reassure them it\'s only used for this. Never pressure; accept a no gracefully.' },
  { name: 'Emergency Escalation', description: 'Flags urgent or crisis messages for the owner.', triggers: ['emergency', 'urgent', 'asap', 'right now', 'crisis', 'help me please'], content: 'If a message signals a genuine emergency, respond calmly and briefly, avoid guessing at specialized advice, point to appropriate real-world help, and make clear I\'m being notified so a real person can step in.' },
  { name: 'Small Talk', description: 'Keeps light, friendly conversation flowing.', triggers: ['how are you', 'what\'s up', 'how\'s it going', 'good morning', 'hey there'], content: 'For casual chit-chat: be warm, natural and brief, mirror their energy, ask a light question back when it fits, and don\'t over-explain. This is connection, not a task.' },
  { name: 'Data Privacy Guard', description: 'Refuses to disclose sensitive info.', triggers: ['password', 'ssn', 'social security', 'bank details', 'credit card', 'otp', 'verification code'], content: 'Never share passwords, codes, financial details or other sensitive information, and never ask for them over chat. If someone requests such data, politely decline and suggest a secure, official channel.' },
  { name: 'Deadline Reminder', description: 'Sends polite nudges about due dates.', triggers: ['deadline', 'due date', 'by when', 'reminder', 'don\'t forget'], content: 'For deadline-related messages: confirm the date clearly, offer a gentle reminder framing, and ask if they need anything to hit it. Encouraging, never nagging.' },
];
